...
| `/models` | **Models** | Regime overlay chart (MSM/HMM/HMM_Uni/LSTM/Transformer), label concordance, model plots, Optuna heatmaps, HPO analysis reports (convergence, objective sensitivity, DSR/PBO, multi-seed) |
